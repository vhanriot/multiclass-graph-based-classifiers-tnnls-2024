...
SEED = 21
CLFS = {
    "ggrbf": {"clf": GGRBF, "params": params["ggrbf"]},
...
def call_eval(dataset, clf_name, tune_with_cv=False, eval_with_cv=False):
    ...
    if eval_with_cv:
        ...
        for i, (train_index, test_index) in enumerate(skf.split(X, y)):
            ...
            func = lambda trial: objective(trial, X_train, y_train, n_classes, model, params, tune_with_cv=tune_with_cv)
        ...
        file_dir = RESULTS_DIR / f"gg_baselines/{clf_name}"
